...
public class MatchDemo {
	...
	public static void main(String[] args) {
		...
		Optional<Nation> nation = Nation.nations.stream().findFrist();
		nation.ifPresentOrEls(Util::print,()->System.out.print("없음"));
		System.out.println();
		
		nation = Nation.nations.stream().filter(Nation::isIslane).findAny();
